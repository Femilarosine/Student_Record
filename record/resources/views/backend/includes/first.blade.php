                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="{{ asset('backend/assets/images/faces/face10.jpg') }}" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="{{ asset('backend/assets/images/faces/face13.jpg') }}" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="{{ asset('backend/assets/images/faces/face16.jpg') }}" alt="image" />
                                <div class="table-user-name ml-3">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                      <img class="survey-img mb-lg-3" src="{{ asset('backend/assets/images/dashboard/img_3.jpg') }}" alt="" />
                      <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="{{ asset('backend/assets/images/dashboard/img_1.jpg') }}" alt="" />
                      <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="{{ asset('backend/assets/images/dashboard/img_2.jpg') }}" alt="" />
                      <div class="pt-2">

<div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
       ...
       <h1 class="text-info">DON BOSCO</h1>
        </div>
        <ul class="nav">
        ...
        @if(Auth::user()->user_type == "student")
          <li class="nav-item">
            <a class="nav-link" href="{{route('view.stu',Auth::user()->id)}}">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href="{{route('count.stu')}}">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
          <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
            <a class="navbar-brand brand-logo-mini align-self-center d-lg-none" href="#"><img src="{{ asset('assets/images/logo-mini.svg') }}" alt="logo" /></a>
